<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="FileManagementSystem.SignUp" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Your Files</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="your files info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
